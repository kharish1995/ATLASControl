...
/////////////////////////////////////////////////
AtlasErrorCode AtlasSimInterface::open_net_connection_to_robot(
...
/////////////////////////////////////////////////
AtlasErrorCode AtlasSimInterface::close_net_connection_to_robot()
{
  std::cout << __PRETTY_FUNCTION__ << std::endl;
  return NO_ERRORS;
}
...
/////////////////////////////////////////////////
bool AtlasSimInterface::net_connection_open()
{
  std::cout << __PRETTY_FUNCTION__ << std::endl;
  return true;
}
...
AtlasErrorCode AtlasSimInterface::get_robot_ip_address(
...
/////////////////////////////////////////////////
AtlasErrorCode AtlasSimInterface::stop(int64_t *_packetSeqId)
{
  std::cout << __PRETTY_FUNCTION__ << std::endl;
  return NO_ERRORS;
}
...
/////////////////////////////////////////////////
bool AtlasSimInterface::command_in_progress()
{
  std::cout << __PRETTY_FUNCTION__ << std::endl;
  return false;
}
...
/////////////////////////////////////////////////
AtlasErrorCode AtlasSimInterface::send_control_data_to_robot(
...
/////////////////////////////////////////////////
AtlasErrorCode AtlasSimInterface::new_control_data_from_robot_available(
...
/////////////////////////////////////////////////
AtlasErrorCode AtlasSimInterface::get_control_data_from_robot(
...
/////////////////////////////////////////////////
AtlasErrorCode AtlasSimInterface::clear_faults(int64_t *_packetSeqId)
{
  std::cout << __PRETTY_FUNCTION__ << std::endl;
  return NO_ERRORS;
}
...
/////////////////////////////////////////////////
std::string AtlasSimInterface::get_error_code_text(AtlasErrorCode _ec) const
{
  std::cout << __PRETTY_FUNCTION__ << std::endl;
  return("hello");
}
...
/////////////////////////////////////////////////
std::string AtlasSimInterface::get_run_state_as_string(
...
/////////////////////////////////////////////////
std::string AtlasSimInterface::get_status_flag_as_string(
...
/////////////////////////////////////////////////
std::string AtlasSimInterface::link_name_from_link_id(
...
/////////////////////////////////////////////////
AtlasLinkId AtlasSimInterface::link_id_from_link_name(std::string _linkName) const
{
  std::cout << __PRETTY_FUNCTION__ << std::endl;
  return LINK_PELVIS;
}
...
/////////////////////////////////////////////////
std::string AtlasSimInterface::joint_name_from_joint_id(
...
/////////////////////////////////////////////////
AtlasJointId AtlasSimInterface::joint_id_from_joint_name(
...
/////////////////////////////////////////////////
std::string AtlasSimInterface::behavior_name_from_behavior(
...
/////////////////////////////////////////////////
AtlasRobotBehavior AtlasSimInterface::behavior_from_behavior_name(
